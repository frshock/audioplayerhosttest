...
// The provided Router setup for this project.
// Note that the App Component will always be visible in this configuration, with the other components nested inside.
// Since we want our song to continue playing while we navigate in our app, we will want to have our audio player in the App component.
ReactDOM.render((
